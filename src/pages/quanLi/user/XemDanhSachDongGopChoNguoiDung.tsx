...
import { LoaiPhi, useDanhSachDongGopChoNguoiDungQuery } from "../../../graphql/generated/schema";
  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        Header: "Loại phí",
        // @ts-ignore
        accessor: (row) => (row["khoanPhi"].loaiPhi==LoaiPhi.BatBuoc ? "Bắt buộc" : "Ủng hộ"),
      },
      {
